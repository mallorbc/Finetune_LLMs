...
def replace_attn_with_flash_attn(is_70B=False):
    ...
    if not is_70B:
        transformers.models.llama.modeling_llama.LlamaAttention.forward = forward7B13B
    else:
        transformers.models.llama.modeling_llama.LlamaAttention.forward = forward70B
